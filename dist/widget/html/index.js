export const getAll = (c) => {
    ...
    const ButtonMUI = (label, id, className = '') => {
        return `
    ...
    const InputMUI = (label, inputParams = {}, datalist = '') => {
    ...
    const CloseButtonMUI = (className) => {
        return `
    ...
    const getKaitenLink = (link, className) => `
    <a
      href="${link}"
      target="_blank"
  ...
  `;
    ...
    const getCreateBranch = () => {
        return ButtonMUI('+', c('createBranchBtn'), c('createBranchBtn'));
    };
    const getCreateMR = () => {
        return ButtonMUI('+', c('createMR'), c('createMR'));
    };
    const getErrorMessageCont = () => {
        return `
    <div class="${c('error-message-cont')}"></div>
    `;
    };
    const getErrorMessageItem = (message) => {
        return `
    ...
    ${getErrorMessageCont()}
  `;
    const getBranchList = (arr, projects) => `
  ...
  `;
    const getFormMR = (cardId, selectProject, selectsBranch, selectsUser) => `
    <div class="${c('form')}">
      ${selectProject}
    ...
    ${getErrorMessageCont()}
  `;
    const getFormCreateBranch = (cardId, selects, selectType) => `
    <div class="${c('form')}">
      ${selects}
